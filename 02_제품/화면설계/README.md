...
주요 화면 8개와 팝업·상태를 포함한 21개 프레임을 Figma로 옮겼으며 원본 캡처 21개와 설명 번호 73개를 문서 공통 입력에 반영함 기본 캡처는 1440×1120px이며 홍보 제안은 아래 버튼이 보이도록 1440×1240px로 캡처함 긴 화면은 Figma 프레임 안에 스크롤할 내용이 유지됨 공유 링크의 비로그인 열람은 CloudFront 403으로 미검증 상태임
